...
const translations = {
    pt: {
        ...
        "hero.cta.secondary":"📋 Catálogo de Serviços",
        ...
        "qa.monitoring.desc":     "Monitorar a base de conhecimento para incluir detalhes do GuIA Amazônico assim que o banco de dados do Supabase for integrado à memória de longo prazo do agente.",
        "qa.monitoring.tag":      "🕐 Próxima Sprint — V35",
        ...
        "cta.final.btn":   "Iniciar meu Projeto →",

        // Footer
        "footer.tagline":             "Tecnologia com propósito. IA com alma.",
        "footer.transparency.label":  "Nota de Transparência:",
        "footer.transparency.text":   "Este projeto foi idealizado, arquitetado e validado por Lídi Moura. A IA foi utilizada como suporte de pair programming para acelerar o código, enquanto a gestão técnica e as integrações permanecem sob aprendizado contínuo (Heutagogia) em Data Science.",
    },
    ...
    en: {
        ...
        "hero.cta.secondary":"📋 Service Catalog",
        ...
        "qa.monitoring.desc":     "Monitor the knowledge base to include GuIA Amazônico details once the Supabase database is integrated into the agent's long-term memory.",
        "qa.monitoring.tag":      "🕐 Next Sprint — V35",
        ...
        "cta.final.btn":   "Start my Project →",

        "footer.tagline":             "Technology with purpose. AI with soul.",
        "footer.transparency.label":  "Transparency Note:",
        "footer.transparency.text":   "This project was idealized, architected and validated by Lídi Moura. AI was used as pair programming support to accelerate the code, while technical management and integrations remain under continuous learning (Heutagogy) in Data Science.",
    },
    ...
    es: {
        ...
        "hero.cta.secondary":"📋 Catálogo de Servicios",
        ...
        "qa.monitoring.desc":     "Monitorear la base de conocimiento para incluir detalles del GuIA Amazônico una vez que la base de datos de Supabase se integre en la memoria a largo plazo del agente.",
        "qa.monitoring.tag":      "🕐 Próximo Sprint — V35",
        ...
        "cta.final.btn":   "Iniciar mi Proyecto →",

        "footer.tagline":             "Tecnología con propósito. IA con alma.",
        "footer.transparency.label":  "Nota de Transparencia:",
        "footer.transparency.text":   "Este proyecto fue ideado, arquitectado y validado por Lídi Moura. La IA fue utilizada como soporte de pair programming para acelerar el código, mientras la gestión técnica y las integraciones permanecen bajo aprendizaje continuo (Heutagogía) en Data Science.",
    }
};
